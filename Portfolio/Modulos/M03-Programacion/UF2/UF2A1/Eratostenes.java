...
public class Eratostenes {   // Abre clase Eratostenes
    ...
    public static void Imprime(boolean A[], int Tamano) { //ABRE IMPRIME
        int contador = 0;

        for (int m = 2; m <= Tamano; m++) { //ABRE FOR
            if (true == A[m]) {
                contador++;
            }
        } //CIERRA FOR
        ...
        int salto = 1;
        for (int n = 1; n <= Tamano; n++) { //ABRE FOR

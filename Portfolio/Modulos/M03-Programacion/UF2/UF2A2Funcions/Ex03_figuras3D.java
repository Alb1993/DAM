...
public class ex03_figuras3D {
    ...
    /*
    "Que demani el tipus de figura 3D (cilindre, hexaedre, tetraedre o esfera) i a continuació demani les dades 
    necessàries per a cadascun i en mostri la superfície i el volum".
    */
    ...
    System.out.println("Perimetro: " + String.format("%.2f",resultado));
    System.out.println("Volumen: " + String.format("%.2f",resultado2));
    }

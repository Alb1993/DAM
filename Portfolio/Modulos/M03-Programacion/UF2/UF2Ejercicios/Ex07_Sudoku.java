...
public class Ex07_Sudoku {
    ...
    public static int sudoku = 0;
    public static int[][] arraySudoku = new int[fila][columna];
    ...
    public static void introSudoku(){
        
        for(int i=0; i<fila; i++){}
        System.out.println("Intro Sudoku");
        sudoku=in.nextInt();
        creaSudoku();
    ...
    public static void creaSudoku(){
        ...
        for(int i=0; i<fila; i++){
            for(int j=0; j<columna; j++){
                if(sudoku.charAt(j) != " "){
                    arraySudoku[i][j]=sudoku.charAt(j);
                }
            }    
        }
        comprobarSudoku();
